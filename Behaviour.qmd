...
Use these to spot zero vs non‑zero disagreements, misses/false alarms, and timing offsets during wet events.
...
Rolling diagnostics reveal gradual offsets or drift through time (look for breaks away from 0 bias or changing correlation).
