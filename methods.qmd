...
Windy‑day metrics use the top 10% of reference wind speeds (`windy_top_pct = 0.10`), i.e., the 90th percentile of the reference wind during the overlap period. (A fixed threshold of 10 m/s is coded as an alternative but not used in th
