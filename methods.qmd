...
Analyses were performed in R [@r:alan2024]. Data wrangling and visualization use dplyr, tidyr, ggplot2, readr, purrr, tibble, lubridate, and slider [@dplyr; @tidyr; @ggplot2; @readr; @purrr; @tibble; @lubridate; @slider], alongside the tidyverse meta-package [@tidyverse]. Spatial processing relies on sf [@sf] with leaflet, tmap, osmdata, rnaturalearth, and rnaturalearthdata for mapping [@leaflet; @tmap; @osmdata; @rnaturalearth; @rnaturalearthdata]. Interactive graphics and tables are produced with plotly, reactable, and gt [@plotly; @reactable; @gt]. Reproducibility and reporting use renv, knitr, rmarkdown, htmltools, and here [@renv; @knitr; @rmarkdown; @htmltools; @here].
